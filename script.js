window.addEventListener("DOMContentLoaded", () => {
  import("https://www.gstatic.com/firebasejs/10.10.0/firebase-app.js").then(({ initializeApp }) => {
    import("https://www.gstatic.com/firebasejs/10.10.0/firebase-auth.js").then(({ getAuth, signInWithEmailAndPassword, createUserWithEmailAndPassword, onAuthStateChanged, signOut }) => {
      import("https://www.gstatic.com/firebasejs/10.10.0/firebase-firestore.js").then(({ getFirestore, collection, addDoc, deleteDoc, doc, query, where, onSnapshot }) => {
        ...
        document.getElementById("loginBtn").onclick = () => {
          ...
          signInWithEmailAndPassword(auth, email, pass)
            .then(() => {
              const code = prompt("Insert key to access vault:");
              if (code === "gypsy") {
                showVault();
              } else {
                alert("Wrong key!");
